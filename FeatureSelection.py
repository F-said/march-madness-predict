...
X_train = pd.read_csv("/Users/farukhsaidmuratov/PycharmProjects/MarchMadness/2018/X_train_seedordinal.csv").drop(labels="Team1", axis=1).drop(labels="Team2", axis=1)\
