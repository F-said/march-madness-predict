...
I used this data-set to take note of the last known ordinal rank of each basketball team before the tournament began. Then, I created a seperate data-set that recorded the difference between the ordinal systems of two teams that played each other and the resulting outcome of such a matchup (1, Team1 won; or 0, Team1 lost).

To allow the model to observe both negative and positive outcomes, I used a "coin-flip" to randomly choose if Team1 was the winning team or the losing. The resultant data-set looked contained two teams, their ordinal differences, and a target "1" which indicates Team1 won, or "0" which indicates Team0 lost.

<figure>
  <img src="images\diff.png" id="large-image">  
    <figcaption>Transformed dataset</figcaption>
</figure>
